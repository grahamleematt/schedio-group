...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border-base bg-white/94 px-4 backdrop-blur-xl">
      <nav className="page-wrap flex flex-col gap-4 py-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex min-w-0 flex-1 flex-wrap items-center gap-2 lg:max-w-[420px] lg:flex-none lg:justify-end">
          <div className="min-w-0 flex-1 rounded-[1.3rem] border border-border-strong bg-surface-panel px-3 py-2 shadow-xs lg:flex-none lg:min-w-[320px]">
